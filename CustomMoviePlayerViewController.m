...
- (void) moviePlayerLoadStateChanged:(NSNotification*)notification 
{
	...
	if ([mp loadState] != MPMovieLoadStateUnknown)
	{
		...
		[[self view] setBounds:CGRectMake(0, 0, self.parentViewController.view.bounds.size.height, self.parentViewController.view.bounds.size.width)];
		[[self view] setCenter:CGPointMake(self.parentViewController.view.bounds.size.width/2, self.parentViewController.view.bounds.size.height/2)];
		[[self view] setTransform:CGAffineTransformMakeRotation(M_PI / 2)]; 
		
		// Set frame of movieplayer
		[[mp view] setFrame:CGRectMake(0, 0, self.parentViewController.view.bounds.size.height, self.parentViewController.view.bounds.size.width)];
